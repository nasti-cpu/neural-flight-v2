...
Node.js is another **JavaScript runtime**. In this project, you need it so the WebSocket-related tooling works reliably on your machine. Think of it as the platform many JavaScript tools expect to find.
...
> 💡 **Which version should I use?** Use the current LTS version if possible. The Homebrew package gives you a standard, up-to-date installation.
