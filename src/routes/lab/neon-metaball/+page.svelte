<script lang="ts">
	...
	import { createMetaballs, type MetaballsResult } from '$lib/three/lab/metaballs';
	import { createReflectiveWater, type ReflectiveWaterResult } from '$lib/three/lab/reflective_water';
