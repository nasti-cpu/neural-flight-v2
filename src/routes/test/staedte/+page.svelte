    ...
    const MODES: ModeDef[] = [
        {
            id: "altstadt",
            label: "Altstadt",
            description: "Enge Gassen, warmes Licht",
        },
        {
            id: "zentrum",
            label: "Zentrum",
            description: "Wolkenkratzer, kühles Blau",
        },
        {
            id: "vorort",
            label: "Vorort",
            description: "Flach, weitläufig, heimelig",
        },
        {
            id: "kolonie",
            label: "Kolonie",
            description: "Unterwasser-Habitat, cyan Biopore",
        },
    ];
