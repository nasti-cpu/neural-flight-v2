...
<script lang="ts">
	...
	const testPages = [
		{ slug: "wiese", name: "Wiese" },
		{ slug: "wiese-himmel", name: "Wiese & Himmel" },
		{ slug: "wiese-komplett", name: "Wiese Komplett" },
		{ slug: "blauer-himmel", name: "Blauer Himmel" },
		{ slug: "blumen", name: "Blumen" },
		{ slug: "bienen", name: "Bienen" },
		{ slug: "schmetterlinge", name: "Schmetterlinge" },
		{ slug: "stadt", name: "Stadt" },
		{ slug: "pheromon-abstand", name: "Pheromon Abstand" },
		{ slug: "facettenauge", name: "Facettenauge" },
		{ slug: "insekten-vergleich", name: "Insekten Vergleich" },
		{ slug: "insekten-welt-v2", name: "Insekten Welt V2" },
		{ slug: "erlebnis", name: "Erlebnis" },
		{ slug: "city-guide-path", name: "City Guide Path" },
		{ slug: "guidepath-ab", name: "Guidepath AB" },
	];
