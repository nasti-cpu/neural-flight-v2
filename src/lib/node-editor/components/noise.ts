/**
 * Noise — Smooth random signal via lerp between random targets.
 *
 * Stateful. Generates organic, slowly-changing random values.
 * Input: speed (0-1, high = fast changes)
...
// --- Configurable ranges ---
/** Fastest period in seconds (speed=1) */
const PERIOD_MIN = 0.1;
/** Slowest period in seconds (speed=0) */
...
export const COMPONENT_NOISE: SignalDef = {
	type: "noise",
	label: "Noise",
